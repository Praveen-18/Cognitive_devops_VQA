...
def preprocessingEmbeddings():
	dataset = "VQA/svm_face_recognation/dataset"

	embeddingFile = "VQA/svm_face_recognation/output/embeddings.pickle" #initial name for embedding file
	embeddingModel = "VQA/svm_face_recognation/openface_nn4.small2.v1.t7" #initializing model for embedding Pytorch

	#initialization of caffe model for face detection
	prototxt = "VQA/svm_face_recognation/model/deploy.prototxt"
	model =  "VQA/svm_face_recognation/model/res10_300x300_ssd_iter_140000.caffemodel"
